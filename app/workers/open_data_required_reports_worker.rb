...
class OpenDataRequiredReportsWorker
  ...
  # Returns the URL with search params for a required report.
  #
  # For example:
  #   https://a860-gpp.nyc.gov/catalog?utf8=%E2%9C%93&locale=en&agency=Agency&required_report_name=Required%20Report&sort=date_published_ssi+desc&search_field=advanced
