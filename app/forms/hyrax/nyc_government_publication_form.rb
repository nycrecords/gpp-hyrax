...
module Hyrax
  ...
  class NycGovernmentPublicationForm < Hyrax::Forms::WorkForm
    ...
    self.terms = [:title, :sub_title, :agency, :required_report_name, :additional_creators, :subject, :description,
    ...
    self.required_fields = [:title, :agency, :required_report_name, :subject, :description, :date_published,
