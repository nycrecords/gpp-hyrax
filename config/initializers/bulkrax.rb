...
Bulkrax.setup do |config|
  ...
  config.default_work_type = 'NycGovernmentPublication'
  ...
  config.field_mappings['Bulkrax::CsvParser'] = {
    "title" => { from: ["title"] },
    "sub_title" => { from: ["sub_title", split: ';' ] },
    "agency" => { from: ["agency"], split: "; " },
    "required_report_name" => { from: ["required_report_name"], split: ';'  },
    "additional_creators" => { from: ["additional_creators"] },
    "subject" => { from: ["subject"] },
    "description" => { from: ["description"], split: ';'  },
    'date_published' => { from: ['date_published'] },
    "report_type" => { from: ["report_type"], split: "; " },
    "language" => { from: ["language"], split: ';'  },
    "fiscal_year" => { from: ["fiscal_year"] },
    "calendar_year" => { from: ["calendar_year"] },
    "borough" => { from: ["borough"], split: ';'  },
    'school_district' => { from: ['school_district'] },
