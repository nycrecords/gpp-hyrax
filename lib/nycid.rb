...
module NYCID
  ...
  class NYCIDWebServices
    ...
    TOU_ENDPOINT = '/account/user/termsOfUse.htm'.freeze
    # Check if user has accepted NYC.ID Terms of Use Policy
    TOU_STATUS_ENDPOINT = '/account/api/isTermsOfUseCurrent.htm'.freeze
    # Enroll (authorize) a user to authenticate to your application
    ENROLLMENT_ENDPOINT = '/account/api/enrollment.htm'.freeze
    # Check if user has enrolled (is authorized) to access your application.
    ENROLLMENT_STATUS_ENDPOINT = '/account/api/getEnrollment.htm'.freeze
